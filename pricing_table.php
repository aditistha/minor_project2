				...
				<div class="row">
					<div class="col-md-4">
						...
						<div class="generic_content clearfix">
							...
							<div class="generic_feature_list">
								<ul>
									<li><span>Limited</span> Songs</li>
									<li><span>Limited </span> Artist</li>
									<li><span>General</span> Experience</li>
								</ul>
							</div>
							<!--//FEATURE LIST END-->
					...
					<div class="col-md-4">
						...
						<div class="generic_content active clearfix">
							...
							<div class="generic_feature_list">
								<ul>
									<li><span>Selective</span> Songs</li>
									<li><span>Selective</span> Artist</li>
									<li><span>Better</span> Experience</li>
								</ul>
							</div>
							<!--//FEATURE LIST END-->
							...
							<div class="generic_price_btn clearfix">
								...
								<!-- <form action="payment_gateway.php" method="POST">
									<input type="hidden" name="name" value="standard" id="name">
									<input type="hidden" name="price" value = "499.99" id="price">
									<a><input type="submit" name="Buy now" class="pay"></a>
								</form> -->
							</div>
							<!--//BUTTON END-->
					...
					<div class="col-md-4">
						...
						<div class="generic_content clearfix">
							...
							<div class="generic_feature_list">
								<ul>
									<li><span>Unlimited </span> Songs</li>
									<li><span>Unlimited </span> Artist</li>
									<li><span>Best </span> Experience</li>
								</ul>
							</div>
							<!--//FEATURE LIST END-->
